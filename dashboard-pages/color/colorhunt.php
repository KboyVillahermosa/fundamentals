    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Color Hunt</h1>
                <p class="text-gray-600 dark:text-gray-300"> Color Hunt is a free and open platform designed to inspire creativity through color. Here's why it's your ultimate resource for discovering captivating color palettes</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/colorhunt.png" alt="">
                <a href="https://sipapp.io" target="_blank">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Mode stands out as a versatile platform that caters to the diverse needs of data professionals while promoting a culture of data-driven decision-making throughout the organization. With Mode, every stakeholder has the tools and resources they need to leverage data effectively and drive success.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Vibrant Collection: </span> Explore an extensive collection of meticulously curated color palettes, each handpicked to evoke emotion, spark imagination, and elevate your designs. From bold and vibrant hues to soft and subtle tones, Color Hunt offers a diverse range of color combinations to suit any project.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Unlimited Inspiration:  </span> Whether you're designing a website, crafting a logo, or creating digital artwork, Color Hunt provides endless inspiration to fuel your creativity. Discover new color schemes, experiment with different combinations, and find the perfect palette to bring your vision to life.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Easy Navigation: </span> Navigate Color Hunt's user-friendly interface with ease, allowing you to browse through color palettes effortlessly. Filter by popularity, date, or specific themes to find the perfect palette for your project in seconds.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Seamless Integration: </span> Integrate Color Hunt seamlessly into your design workflow with downloadable palettes available in various formats, including HEX, RGB, and HSL. Simply copy the colors or download the palette to your preferred design tool and start creating.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Accessible and Free:  </span> Enjoy unlimited access to Color Hunt's vast collection of color palettes without any cost or subscription fees. Whether you're a seasoned designer or a hobbyist exploring the world of color, Color Hunt is accessible to everyone, everywhere.</p>
            </div>
        </div>
    </section>
