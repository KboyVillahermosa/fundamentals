    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Spectrum by Adobe</h1>
                <p class="text-gray-600 dark:text-gray-300"> With a comprehensive suite of components and tools, Spectrum empowers product teams to work more efficiently while ensuring Adobe's applications maintain a cohesive and seamless experience.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/Spectrum by Adobe.png" alt="">
