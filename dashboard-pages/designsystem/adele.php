    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Adele</h1>
                <p class="text-gray-600 dark:text-gray-300"> it's a comprehensive collection of publicly available design systems and pattern libraries from around the world. Whether you're a designer, developer, or product manager, 
                    Adele provides a centralized hub where you can discover, explore, and implement the latest design trends and best practices.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/adele.png" alt="">
        ...
        <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> With Adele, the possibilities are endless. Whether you're designing websites, mobile apps, or digital interfaces, Adele empowers you to create exceptional experiences that resonate with your users and drive business success.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Curated selection: </span>  Adele curates a diverse selection of design systems and pattern libraries, ensuring that you have access to the most relevant and up-to-date resources. From industry giants to emerging startups, 
                Adele features a wide range of design systems to suit every project and aesthetic.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Streamlined discovery: </span> Searching for design inspiration can be overwhelming, but Adele simplifies the process with its intuitive search and filtering options.
                 Whether you're looking for a specific type of design system or exploring new trends, Adele makes it easy to find exactly what you need.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Collaboration opportunities </span> Adele fosters collaboration and knowledge sharing within the design community. Whether you're sharing your own design system or learning from others, Adele provides a platform for designers to connect, collaborate, and grow together.   </p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Free and open access </span> Adele is completely free and open to the public. No subscriptions, no paywalls just unlimited access to a wealth of design resources at your fingertips. Whether you're a seasoned professional or a curious beginner, Adele welcomes you to explore and discover the world of design systems.</p>
            </div>
        </div>
    </section>
