    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            ...
            <div class="tools-image">
                <img src="../dash-images/mysql-documentation.png" alt="">
        ...
        <div class="tools-description-content">
            ...
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Comprehensive Guides: </span>  Access detailed guides covering every aspect of MySQL, from installation and configuration to advanced usage scenarios. Whether you're a beginner or an experienced user, there's something for everyone.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Installation Assistance:  </span> Follow step-by-step instructions to install MySQL on various operating systems, ensuring a smooth setup process for your database environment.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Configuration Tips: </span> Learn best practices for configuring MySQL to optimize performance, security, and scalability. Discover how to fine-tune settings to meet the specific needs of your applications.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Usage Examples: </span>  Explore a plethora of usage examples, ranging from basic CRUD operations to complex SQL queries and database management tasks. Get hands-on experience with real-world scenarios.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Official Source:   </span>  Benefit from the reliability and accuracy of the official MySQL Documentation. Stay updated with the latest features, enhancements, and best practices recommended by the MySQL development team.</p>
            </div>
        </div>
    </section>
