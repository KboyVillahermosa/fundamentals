    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Adobe Color</h1>
                <p class="text-gray-600 dark:text-gray-300"> Elevate your designs with Adobe Color, your premier destination for curated color palette inspiration. Whether you're a seasoned designer or just starting out, Adobe Color offers a wealth of resources to ignite your creativity and bring your vision to life.</p>
            </div>
        ...
        <div class="tools-description-header">
            ...
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Curated Palettes: </span> Explore a vast collection of meticulously curated color palettes, each handpicked by design experts to inspire and captivate. From harmonious blends to bold contrasts, Adobe Color provides a diverse range of color combinations to suit any project or aesthetic.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Versatile Tools: </span> Take advantage of Adobe Color's versatile tools and features designed to streamline your design workflow. Use the color wheel to create custom palettes, extract colors from images, or explore trending color themes—all with intuitive controls and seamless integration.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Endless Inspiration: </span> Gain inspiration from a thriving community of designers, artists, and creatives on Adobe Color's platform. Discover new trends, share your own creations, and engage in meaningful discussions to stay inspired and connected.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Integration with Adobe Creative Cloud: </span> Seamlessly integrate Adobe Color with your favorite design tools and workflows through Adobe Creative Cloud. Access your color palettes across various Adobe applications, including Photoshop, Illustrator, and InDesign, for a cohesive and efficient design experience.</p>
            </div>
            <div class="tools-description-content">
