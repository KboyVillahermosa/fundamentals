    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Ziplin</h1>
                <p class="text-gray-600 dark:text-gray-300"> Zeplin goes beyond traditional design handoff tools to unite your product team and accelerate design delivery at scale. From version control to user flows, design systems, sign-offs, and more, Zeplin streamlines the entire design process, empowering your team to collaborate efficiently and effectively.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/ziplin.png" alt="">
        ...
        <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300">  Zeplin empowers your product team to work more efficiently and effectively than ever before. Say goodbye to fragmented workflows and communication bottlenecks—Zeplin unites your team and accelerates design delivery at every stage of the process.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Version control:</span> Say goodbye to version control headaches. Zeplin provides a centralized repository for your design files, ensuring that everyone on your team has access to the latest versions and revisions.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">User flows: </span> Visualize and document user flows with ease using Zeplin's intuitive interface. With features like interactive prototypes and annotations, you can communicate complex user journeys clearly and effectively.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Design systems: </span> Keep your design system organized and up-to-date with Zeplin's robust design system management tools. From component libraries to style guides, Zeplin empowers your team to maintain consistency and coherence across all your projects.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Collaboration at scale: </span> Whether you're a small team or a large organization, Zeplin scales with you. With features like team collaboration, project management, and real-time commenting, Zeplin ensures that everyone on your team is on the same page and working towards the same goals.</p>
            </div>
        </div>
    </section>
