            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="../../dashboard-pages/dashboard.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="ms-3">Introductiob</span>
                    </a>
                </li>
                <li>
    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Evergreen</h1>
                <p class="text-gray-600 dark:text-gray-300"> it's a powerful React UI framework brought to you by Segment, designed to empower developers to build ambitious and innovative products on the web. With Evergreen, you have everything you need to create stunning, intuitive, and scalable user interfaces that drive your business forward.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/evergreen.png" alt="">
                <a href="https://spectrum.adobe.com" target="_blank">
        ...
        <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> With Spectrum, Adobe is leading the way in design systems, empowering product teams to create exceptional experiences that delight users and drive business success. </p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Comprehensive component library:  </span> Spectrum provides a comprehensive library of components, from buttons and forms to navigation menus and icons. With pre-built, customizable components, product teams can accelerate their development process and maintain consistency across Adobe's suite of applications.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Streamlined collaboration: </span> Spectrum fosters collaboration among product teams, designers, and developers, enabling seamless communication and alignment throughout the design and development process. With shared resources and guidelines, teams can work together more efficiently, bringing products to market faster.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Consistency and cohesion: </span>  Adobe's applications are used by millions of users worldwide, and maintaining consistency across these applications is essential for providing a seamless user experience. Spectrum ensures that Adobe's products adhere to a unified design language, making them more intuitive and user-friendly.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Accessibility and inclusivity: </span> Spectrum prioritizes accessibility and inclusivity, ensuring that Adobe's applications are usable by everyone, regardless of their abilities or backgrounds. With accessible components and design guidelines, Spectrum helps product teams create products that are accessible to all users.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Continuous improvement:</span>  Spectrum is a living, evolving system that adapts to the changing needs of Adobe's users and the design industry as a whole. With ongoing updates and enhancements, Spectrum ensures that Adobe's applications remain at the forefront of design innovation and excellence.</p>
            </div>
        </div>
    </section>
