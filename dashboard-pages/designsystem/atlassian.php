    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Atlassian</h1>
                <p class="text-gray-600 dark:text-gray-300"> Atlassian is your go-to destination for creating simple, intuitive, and beautiful experiences from start to finish.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/atlassian.png" alt="">
        ...
        <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300">  Atlassian provides the tools, resources, and support you need to bring your ideas to life. Join thousands of teams worldwide who trust Atlassian to design, develop, and deliver excellence every step of the way.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Comprehensive design language: </span> Collaboration shouldn't be a hassle—it should be seamless and intuitive. With Polaris, teams can work together effortlessly, sharing ideas, giving feedback, and iterating in real-time, no matter where they are in the world.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Simplified workflow:</span>   Atlassian offers a suite of integrated products that seamlessly connect design, development, and delivery, streamlining your workflow and enabling collaboration across teams and disciplines.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Intuitive design tools: </span>   Whether you're a seasoned designer or just getting started, Atlassian's intuitive design tools make it easy to bring your ideas to life. From wireframing and prototyping to high-fidelity design and user testing, our tools empower you to create stunning experiences that resonate with your users.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Agile development: </span> Atlassian embraces agile principles and practices, allowing teams to iterate quickly, adapt to change, and deliver value to customers faster.</p>
            </div>
        </div>
    </section>
