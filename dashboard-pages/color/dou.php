    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Dou</h1>
                <p class="text-gray-600 dark:text-gray-300"> Duo is your premier destination for a curated collection of color combinations, meticulously selected to elevate your design projects. With Duo, you can effortlessly discover harmonious color schemes that will breathe life into your creations and captivate your audience.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/adobe-color.png" alt="">
                <a href="https://color.adobe.com/explore" target="_blank">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Experience the power of color with Duo. Discover curated color combinations, unleash your creativity, and elevate your design projects to new heights. Start exploring Duo today and unlock endless possibilities for your next masterpiece.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Curated Color Combinations: </span> Explore a thoughtfully curated collection of color combinations, handpicked by design experts to ensure aesthetic appeal and visual harmony. From complementary contrasts to subtle gradients, Duo offers a diverse range of palettes to suit every style and mood.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Inspiration at Your Fingertips: </span> TFind inspiration for your design projects with ease, thanks to Duo's user-friendly interface and intuitive navigation. Browse through our curated collections or search for specific color themes to find the perfect palette for your needs.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Real-World Applications: </span> See how each color combination can be applied in real-world design scenarios, providing you with tangible examples of how to use these palettes effectively in your own projects. </p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Easy Integration: </span> Seamlessly integrate Duo into your design workflow with downloadable color codes and palette exports. With support for popular design software and platforms, including Adobe Creative Cloud, Sketch, and Figma, you can easily incorporate Duo's color combinations into your projects.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Community Collaboration: </span>Join a vibrant community of designers and creatives on Duo's platform, where you can share your favorite color combinations, collaborate on projects, and connect with like-minded individuals. </p>
            </div>
        </div>
    </section>
