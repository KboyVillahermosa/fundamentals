    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                ...
                <p class="text-gray-600 dark:text-gray-300"> it's a cohesive framework that shapes every aspect of our platform, ensuring that learners around the world have access to simple, intuitive, and engaging experiences.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/futurelearn.png" alt="">
                <a href="https://storybook.futurelearn.com/?path=/story/welcome--page" target="_blank">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Consistency across the board </span> With the FutureLearn Design System, consistency is key. From typography and color schemes to layout principles and interaction patterns, our design system provides a unified foundation that ensures every learner has a seamless and cohesive experience, no matter where they are on the platform.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Accessibility for all </span> Accessibility is a core principle of the FutureLearn Design System. We believe that learning should be inclusive and accessible to everyone, regardless of their abilities or backgrounds. Our design system prioritizes accessibility standards, ensuring that all learners can access and engage with our content with ease.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Scalability and flexibility </span>  As our platform continues to grow and evolve, the FutureLearn Design System scales with us. Whether we're introducing new features, expanding into new markets, or adapting to emerging technologies, our design system provides the flexibility and scalability we need to innovate and stay ahead of the curve.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Continuous improvement:</span>  The FutureLearn Design System is a living, breathing entity that evolves alongside our platform, incorporating user feedback, industry best practices, and emerging trends to ensure that we're always delivering the best possible experience for our learners.</p>
            </div>
        </div>
    </section>
