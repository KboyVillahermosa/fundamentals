    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Figma</h1>
                <p class="text-gray-600 dark:text-gray-300"> In the world of design collaboration, efficiency and creativity are paramount. Figma revolutionizes the design process by enabling teams to work together in real time, unleashing new possibilities and empowering designers to create like never before.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/figma.png" alt="">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Real-time collaboration:</span>  Break down barriers and foster creativity with real-time collaboration. With Figma,
                 designers can work together on the same project simultaneously, eliminating version control issues and speeding up the design process.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Enhanced visibility: </span> Keep workflows efficient and transparent with tools that provide visibility throughout the entire design process.
                 From initial concept to final iteration, every team member has insight into the project's progress and direction.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Seamless integration: </span>Integrate Figma into your existing workflow and tools, ensuring a smooth transition and minimal disruption to your team's productivity. Whether you're using other design tools or project management platforms, Figma plays well with others.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">New ways to create: </span>Empower designers to explore new ideas and push the boundaries of creativity. With Figma's powerful features and intuitive interface, designers can bring their visions to life with ease, from wireframes to high-fidelity prototypes.Empower designers to explore new ideas and push the boundaries of creativity. With Figma's powerful features and intuitive interface, designers can bring their visions to life with ease, from wireframes to high-fidelity prototypes.</p>
            </div>
        </div>
    </section>
