    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                ...
                <p class="text-gray-600 dark:text-gray-300"> it's a comprehensive framework that empowers designers and developers to create cohesive and user-friendly UI experiences across GitHub's platform. With a focus on shared language and standardized approaches, Primer ensures that every interaction feels familiar and intuitive to users.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/github-primer.png" alt="">
                <a href="https://primer.style" target="_blank">
        ...
        <div class="tools-description-content">
            ...
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Comprehensive guidelines:  </span>Primer provides a comprehensive set of guidelines, principles, and patterns for designing and building UI elements. From buttons and forms to navigation menus and typography, Primer covers all aspects of UI design, ensuring consistency and coherence across GitHub's platform.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Shared language: </span> Primer establishes a shared language for designers and developers, enabling seamless collaboration and communication throughout the design and development process.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Standardized approach: </span>  Primer promotes a standardized approach to UI design, making it easy for teams to deliver cohesive experiences that meet GitHub's high standards for quality and usability. By following established patterns and best practices, teams can streamline their workflow and focus on creating great user experiences.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Flexibility and scalability: </span>  While Primer provides guidelines and principles, it also allows for flexibility and creativity. Teams can adapt and customize the framework to suit the unique needs of their projects, whether they're building a simple website or a complex web application. With Primer, the possibilities are endless.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Community-driven: </span> Primer is not just a set of guidelines it's a vibrant community of designers, developers, and contributors who share a passion for creating exceptional UI experiences. With ongoing updates, contributions, and support from the community, Primer continues to evolve and improve over time.</p>
            </div>
        </div>
    </section>
