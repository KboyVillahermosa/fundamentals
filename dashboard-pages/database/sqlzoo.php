    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            ...
            <div class="tools-image">
                <img src="../dash-images/sql-zoo.png" alt="">
                <a href="https://sqlzoo.net/wiki/SQL_Tutorial" target="_blank">
        ...
        <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Whether you're aiming to advance your career in database management, data analysis, or software development, SQLZoo equips you with the skills and knowledge needed to excel in SQL programming. Start your SQL learning journey today at SQLZoo and unlock the power of relational databases.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Interactive Tutorials: </span>  Dive into SQL concepts through engaging tutorials that guide you step-by-step through various topics, from basic queries to advanced techniques. With interactive exercises, you can apply your knowledge in real-time and reinforce your understanding of SQL principles.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Database System Coverage: </span> SQLZoo covers a wide range of database systems, including MySQL, ensuring that you can learn SQL within the context of the system you're most familiar with or interested in. Whether you're working with MySQL, PostgreSQL, Oracle, or others, SQLZoo has you covered.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Hands-On Learning: </span> Gain practical experience with SQL through hands-on exercises that simulate real-world scenarios. Practice writing SQL queries, manipulating data, and solving challenges to build confidence and proficiency in SQL programming.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Accessible Anywhere, Anytime: </span> SQLZoo's online platform allows you to access tutorials and exercises from anywhere with an internet connection. Whether you're at home, in the office, or on the go, you can continue your SQL learning journey at your own pace.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Community Support:  </span> : Engage with a vibrant community of learners on SQLZoo's forums. Seek assistance, share insights, and collaborate with peers to enhance your SQL learning experience.</p>
            </div>
        </div>
    </section>
