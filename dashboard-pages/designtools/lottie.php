            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        <li>
                            <a href="../designtools/figma.php" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Figma</a>
                        </li>
                        <li>
    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Lottie</h1>
                <p class="text-gray-600 dark:text-gray-300">With Lottie, the power of After Effects animations comes to life in real-time, revolutionizing how apps engage users with dynamic and captivating visual experiences.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/lottie.png" alt="">
        ...
        <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300">  Whether you're creating a mobile game, a productivity app, or an e-commerce platform, Lottie empowers you to captivate users and stand out in a crowded app marketplace.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Seamless integration: </span> Gone are the days of complex animation workflows. With Lottie, developers can seamlessly integrate After Effects animations into their apps with just a few lines of code, making animation implementation as easy as using static images.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">High-quality animations: </span> Elevate your app's visual appeal with stunning animations created in After Effects. Lottie ensures that animations retain their original quality and fidelity, providing users with immersive experiences that leave a lasting impression.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Real-time rendering: </span> Say goodbye to pre-rendered animations and hello to real-time rendering. Lottie enables apps to render animations on the fly, resulting in smoother performance and faster loading times, even on lower-end devices.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Platform versatility: </span> Whether you're developing for iOS, Android, or React Native, Lottie has you covered. With support for multiple platforms, developers can leverage the power of Lottie to create consistent and engaging animation experiences across all devices.</p>
            </div>
        </div>
    </section>
