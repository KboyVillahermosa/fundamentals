...
$sql = "INSERT INTO buyer_data (full_name, address, email, contact_number, payment_method) VALUES ('$fullName', '$address', '$email', '$contactNumber', '$paymentMethod')";
...
<head>
    ...
    <link rel="stylesheet" href="style/cartz.css" />
</head>
...
<body>
    <nav class="border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">GlideSlide</span>
            </a>
    ...
    <section>
        ...
        <div class="total-header" id="totalHeader">
            <div class="total">
    ...
    <form id="checkout-form" action="" method="post" class="p-4 md:p-5">
    <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
        Check Out
    </button>

    <!-- Main modal -->
    <div id="crud-modal" tabindex="-1" aria-hidden="true" class="mode hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <!-- Modal content -->
        <div class="modal-width relative p-4 ">
            <!-- Modal body -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form action="checkout.php" method="post" class="p-4 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="tel" name="contactNumber" id="contactNumber" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Contact Number" required="">
                        </div>
    ...
    <script src="script/cartzzs.js"></script>
