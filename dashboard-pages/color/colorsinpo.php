    ...
    <section class="p-4 sm:ml-64">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Take your design projects to the next level with Colorsinspo. Get more done, faster, and create breathtaking visuals that leave a lasting impression. Try Colorsinspo plugin today and experience the difference it can make in your design workflow.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Effortless Color Selection: </span> Say goodbye to time-consuming color picking. With Colorsinspo, you can quickly and easily choose colors for your projects with just a few clicks, saving you valuable time and effort.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Inspiration on Demand: </span> Need inspiration for your next design project? Colorsinspo has you covered. Explore a vast library of color palettes and find the perfect combination to bring your vision to life.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Customization Options: </span> Tailor your color selections to match your project's unique requirements. Adjust hue, saturation, brightness, and more to create the perfect palette that fits your design aesthetic.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Seamless Integration:  </span> Colorsinspo seamlessly integrates with your favorite design tools and platforms, allowing you to access its powerful features right where you need them. Whether you're using Adobe Creative Cloud, Sketch, Figma, or others, Colorsinspo ensures a smooth and efficient workflow.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Accelerated Productivity </span> By streamlining the color selection process, Colorsinspo helps you work more efficiently and effectively, allowing you to focus on what you do best – designing stunning visuals that captivate your audience.</p>
            </div>
        </div>
    </section>
