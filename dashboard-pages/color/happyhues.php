    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Happy Hues</h1>
                <p class="text-gray-600 dark:text-gray-300"> Finding the perfect colors for your design projects just got easier with Happy Hues. Our platform offers curated color palettes accompanied by real-world examples, helping you visualize how each color could be used in your designs.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/happy-hues.png" alt="">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Spark your creativity and discover new design ideas with Happy Hues. Whether you're a seasoned designer or just starting out, our platform offers inspiration and guidance to help you create stunning visuals that stand out.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Curated Color Palettes: </span> Explore a carefully curated collection of color palettes, each handpicked to inspire creativity and elevate your designs. From vibrant and bold to soft and subtle, Happy Hues offers a diverse range of color combinations to suit any project.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Real-World Examples:  </span>  Gain insight into how each color palette can be applied in real-world design scenarios. Happy Hues provides examples of how colors are used in websites, apps, branding, and more, giving you inspiration and guidance for your own projects.</p>
            </div>
            <div class="tools-description-content">
            ...
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Contextual Inspiration: </span>  Not sure where to use specific colors or how they might complement each other? Happy Hues provides context by showing you how colors are used together in actual design projects, making it easier to envision the possibilities for your own creations.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Inspire Creativity: </span> Spark your creativity and discover new design ideas with Happy Hues. Whether you're a seasoned designer or just starting out, our platform offers inspiration and guidance to help you create stunning visuals that stand out.</p>
            </div>
        </div>
    </section>
