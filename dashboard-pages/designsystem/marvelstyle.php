    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing  Marvel Styleguide</h1>
                <p class="text-gray-600 dark:text-gray-300"> As Marvel expands its product offerings and presence in the market, maintaining a cohesive brand identity across all platforms and products becomes increasingly important.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/marvel-style-guide.png" alt="">
                <a href="https://marvelapp.com/styleguide/overview/introduction" target="_blank">
        ...
        <div class="tools-description-content">
            ...
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Live inventory of UI components: </span> The Styleguide provides a dynamic inventory of UI components, ensuring that designers and developers have access to the latest and most up-to-date resources. From buttons and forms to navigation menus and icons, our UI components are meticulously documented and organized for easy reference.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Brand guidelines and assets: </span> Consistency is key to building a strong brand identity. The Styleguide houses our brand guidelines and assets, including logos, color palettes, typography guidelines, and more. By adhering to these guidelines, we ensure that our brand is represented accurately and consistently across all touchpoints.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Code snippets and developer guidelines:  </span>  For developers, the Styleguide offers code snippets and developer guidelines to facilitate the implementation of our design language. Whether you're building a website, mobile app, or desktop application, our developer resources provide the tools and guidance you need to bring our design vision to life.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Encourages collaboration and upkeep: </span> The Styleguide is a living document that encourages collaboration and input from all team members. Anyone working on Marvel products is encouraged to stay familiar with the Styleguide and contribute to its upkeep.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Drives efficiency and consistency: </span> By centralizing our design language and brand assets in one accessible location, the Styleguide streamlines the design and development process.</p>
            </div>
        </div>
    </section>
