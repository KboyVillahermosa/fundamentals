    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Sketch</h1>
                <p class="text-gray-600 dark:text-gray-300"> it's a complete platform that empowers designers to bring their creative visions to life with ease. Whether you're a seasoned professional or a budding enthusiast, Sketch provides the tools and features you need to design, prototype, collaborate, and more.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/sketch.png" alt="">
        ...
        <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Whether you're designing websites, mobile apps, or digital interfaces, Sketch is the ultimate tool for turning your ideas into reality. Join millions of designers worldwide who trust Sketch to bring their visions to life, and experience the difference for yourself.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Mac app for creators:</span>   Dive into the world of design with Sketch's intuitive Mac app, designed specifically for creators like you. With powerful features for creating, prototyping, and collaborating, Sketch streamlines your workflow and unleashes your creativity.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Web app for collaborators: </span> Extend the power of Sketch to your entire team with the web app, accessible from any browser. Whether you're giving feedback, inspecting designs, or handing off assets, Sketch's web app makes collaboration seamless and efficient for everyone involved.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Complete design platform: </span> From wireframing to high-fidelity prototypes, Sketch offers everything you need to bring your ideas to life in one cohesive platform. With features like Symbols, Libraries, and Plugins, Sketch provides the flexibility and customization options to suit your unique design needs.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Sustainable indie company: </span> Unlike other design platforms owned by tech giants, Sketch is proudly independent and sustainable, driven by a passionate team dedicated to empowering designers since 2010. When you choose Sketch, you're supporting a company that prioritizes your needs and values your input.</p>
            </div>
        </div>
    </section>
