    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Data Camp</h1>
                <p class="text-gray-600 dark:text-gray-300"> Data Camp is your gateway to unlocking the immense potential of data and artificial intelligence through comprehensive learning resources. Whether you're a seasoned professional or just starting your journey in IT/CS, we have everything you need to thrive in the world of data science and AI.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/datacamp.png" alt="">
        ...
        <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Whether you're aspiring to become a data scientist, AI engineer, or simply want to enhance your IT/CS skills, this website provides the resources and support you need to succeed. </p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Python Mastery:  </span> Dive into the versatile world of Python programming language, the backbone of many data science and AI applications. Learn from beginner to advanced levels with hands-on tutorials and real-world projects.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">ChatGPT Integration: </span> Explore the cutting-edge capabilities of ChatGPT, a powerful language model developed by OpenAI. Understand how to leverage ChatGPT for natural language processing tasks, chatbots, and more.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">SQL Fundamentals:</span> Master Structured Query Language (SQL) for efficient database management. Whether it's MySQL, PostgreSQL, or SQLite, we've got you covered with comprehensive SQL tutorials and practical examples.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Power BI Insights: </span> Unleash the power of data visualization with Power BI. Learn how to create compelling dashboards, generate insights, and make data-driven decisions using this popular business intelligence tool.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Interactive Learning: </span> Our platform offers interactive learning experiences with hands-on exercises, quizzes, and projects. Reinforce your knowledge and skills through practical application in a supportive environment.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Community Engagement: </span> Connect with like-minded learners, industry professionals, and expert instructors in our vibrant community. Share insights, ask questions, and collaborate on projects to enhance your learning journey.</p>
            </div>
        </div>
    </section>
