    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Khroma</h1>
                <p class="text-gray-600 dark:text-gray-300"> Designing with colors you love has never been easier with Khroma. Our platform harnesses the power of artificial intelligence to learn your color preferences and generate limitless palettes tailored specifically to your taste.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/khroma.png" alt="">
                <a href="https://www.khroma.co" target="_blank">
        ...
        <div class="tools-description-header">
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Unlock the full potential of color in your designs with Khroma. Let AI empower your creativity and inspire your next masterpiece. Sign up now to discover, search, and save limitless palettes that speak to your unique design sensibilities.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Personalized Palettes: </span> Khroma analyzes your color preferences based on your likes and dislikes, creating personalized palettes that resonate with your unique style and vision.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">AI-Powered Recommendations: </span>  Discover new color combinations effortlessly as Khroma's AI algorithm continuously learns and refines its suggestions based on your interactions and feedback.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Intuitive Search: </span>  Search for specific colors or themes to find the perfect palette for your project. Whether you're looking for vibrant hues, soothing pastels, or bold contrasts, Khroma helps you find exactly what you need.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Save and Organize:  </span> Save your favorite palettes for future reference and organize them according to projects or themes. Khroma ensures that your color inspirations are always at your fingertips whenever you need them.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Seamless Integration:  </span> Integrate Khroma seamlessly into your design workflow with downloadable palettes compatible with popular design tools. Experiment with colors, fine-tune your designs, and bring your creative vision to life with ease.</p>
            </div>
        </div>
    </section>
