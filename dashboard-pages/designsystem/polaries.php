    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Polaris</h1>
                <p class="text-gray-600 dark:text-gray-300"> it's about transforming the entire design process. We're on a mission to revolutionize the way teams collaborate, ensuring that everyone is recognized for their contributions and that magic happens when everyone is truly on the same page.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/polaries.png" alt="">
        ...
        <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Overflow empowers designers to create user flows that not only look great but also function seamlessly. Whether you're designing websites, mobile apps, or digital interfaces, Overflow is the ultimate tool for bringing your ideas to life and communicating them effectively.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Seamless collaboration: </span> Collaboration shouldn't be a hassle—it should be seamless and intuitive. With Polaris, teams can work together effortlessly, sharing ideas, giving feedback, and iterating in real-time, no matter where they are in the world.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Recognition for all:</span>  Every member of the team plays a crucial role in the design process, and at Polaris, we believe in recognizing and celebrating everyone's contributions. From designers to developers to project managers, everyone deserves recognition for their hard work and dedication.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Alignment and clarity: </span>  Design projects can quickly become chaotic without proper alignment and clarity. Polaris ensures that everyone is on the same page, with clear goals, transparent communication, and a shared vision for success.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Magic moments: </span>When everyone is aligned, recognized, and collaborating seamlessly, magic happens. Ideas flow freely, creativity flourishes, and the result is innovative designs that exceed expectations and delight users.</p>
            </div>
        </div>
    </section>
