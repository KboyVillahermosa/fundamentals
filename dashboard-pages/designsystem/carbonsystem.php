    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Carbon Design Project</h1>
            ...
            <div class="tools-image">
                <img src="../dash-images/carbon-system.png" alt="">
        ...
        <div class="tools-description-content">
            ...
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Working code  </span>  Carbon provides developers with a robust library of working code, allowing them to quickly and efficiently implement design elements into their projects. </p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Design tools and resources: </span>  From design files and templates to prototyping tools and resources, Carbon equips designers with everything they need to bring their ideas to life. With a rich library of assets and guidelines, designers can create visually stunning and user-friendly interfaces that meet IBM's high standards for quality and consistency.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Human interface guidelines:  </span>  Carbon is built on the principles of human-centered design, ensuring that products and experiences are intuitive, accessible, and inclusive. With comprehensive human interface guidelines, teams can design with empathy and consideration for diverse user needs and preferences.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Vibrant community of contributors: </span> Carbon is more than just a design system—it's a thriving community of designers, developers, and contributors who share a passion for innovation and collaboration. With ongoing updates, contributions, and support from the community, Carbon continues to evolve and improve over time.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Open source ethos:</span> As an open source project, Carbon encourages transparency, collaboration, and knowledge sharing. By making the design system freely available to the public, IBM empowers teams around the world to leverage Carbon's tools and resources to build better products and digital experiences.</p>
            </div>
        </div>
    </section>
