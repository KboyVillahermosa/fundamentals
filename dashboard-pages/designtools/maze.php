    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Maze</h1>
                <p class="text-gray-600 dark:text-gray-300">With Maze, you can scale customer insights using AI-powered research, from moderated to unmoderated studies, empowering you to build the right products faster than ever before.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/maze.png" alt="">
                <a href="https://maze.co" target="_blank">
        ...
        <div class="tools-description-content">
            ...
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">AI-powered research: </span> Leverage the latest advancements in artificial intelligence to conduct research at scale. Maze's AI-driven capabilities enable you to gather valuable customer insights quickly and efficiently, giving you the data you need to make informed decisions throughout the product development lifecycle.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Moderated and unmoderated studies: </span> Whether you prefer moderated sessions for in-depth interviews or unmoderated studies for larger sample sizes, Maze has you covered. With flexible research options, you can choose the approach that best fits your team's needs and objectives.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Continuous discovery: </span>Product discovery is an ongoing process, and Maze is designed to support you every step of the way. From concept validation to usability testing and beyond, Maze  </p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Empowered product teams: </span> Maze brings product teams together, empowering them to collaborate, iterate, and innovate with confidence. With features like real-time collaboration, project management, and actionable insights, Maze fosters a culture of continuous improvement and success.</p>
            </div>
        </div>
    </section>
