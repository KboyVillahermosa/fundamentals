    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            ...
            <div class="tools-image">
                <img src="../dash-images/abstract.png" alt="">
        ...
        <div class="tools-description-content">
            ...
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Interactive user flows: </span> Say goodbye to static diagrams and hello to dynamic, interactive user flows. With Overflow, you can create visually compelling representations of your user journeys, complete with animations, transitions, and interactions that bring your designs to life.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Stunning design presentations: </span> Impress your audience with stunning design presentations that showcase your work in its best light. With Overflow's presentation mode, you can seamlessly transition between screens, zoom in on details, and highlight key interactions, creating a memorable and engaging experience for your viewers.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Step-by-step walkthroughs: </span> Guide your audience through your designs with ease using Overflow's step-by-step walkthrough feature. Whether you're presenting to clients, stakeholders, or team members, you can provide clear and concise explanations of your design decisions, fostering understanding and alignment across the board.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Synchronous or asynchronous critique: </span> Whether you're conducting real-time design critiques or sharing your work asynchronously, Overflow has you covered. With features like commenting, collaboration, and version history, you can gather feedback, iterate on your designs, and ensure that everyone is on the same page, no matter where they are.</p>
            </div>
        </div>
    </section>
