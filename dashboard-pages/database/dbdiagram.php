    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            ...
            <div class="tools-image">
                <img src="../dash-images/dbdiagram.png" alt="">
        ...
        <div class="tools-description-content">
            ...
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Visual Database Design: </span> Easily create and visualize your database schema using an intuitive drag-and-drop interface.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Multi-Platform Support: </span> Works seamlessly across various database systems, ensuring compatibility and flexibility.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Collaboration: </span>  Collaborate with team members in real-time by sharing and editing database diagrams together.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Version History: </span> Keep track of changes and revisions with version history, allowing you to revert to previous versions if needed.</p>
            </div>
        </div>
    </section>
