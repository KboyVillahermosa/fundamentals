    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            ...
            <div class="tools-image">
                <img src="../dash-images/garden.png" alt="">
        ...
        <div class="tools-description-content">
            ...
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Centralized resource hub: </span> Garden serves as a centralized repository for all tools, standards, and best practices related to product development at Zendesk. From design guidelines and coding standards to project management tools and collaboration resources, Garden has it all.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Source of truth: </span> In a fast-paced environment like Zendesk, it's crucial to have a single source of truth for product development. Garden ensures that everyone is on the same page by providing authoritative guidance on how to approach various aspects of the product development process.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Empowers collaboration </span>  Garden fosters collaboration and knowledge sharing among team members. Whether you're seeking advice on a design challenge, looking for feedback on a code snippet, or sharing insights from user research, Garden provides a platform for collaboration and exchange of ideas.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Drives efficiency and consistency: </span>  By adhering to the tools, standards, and best practices outlined in Garden, teams can work more efficiently and maintain consistency across projects. This ensures that products are not only delivered on time but also meet the high standards expected of Zendesk.</p>
            </div>
            <div class="tools-description-content">
                < class="text-gray-600 dark:text-gray-300"> <span class="span-description">Encourages continuous improvement: </span> </ Garden is a living document that evolves over time to reflect changes in technology, industry trends, and user needs. By encouraging contributions and feedback from all team members, Garden ensures that it remains relevant and up-to-date in an ever-changing landscape.<p>
            </div>
        </div>
    </section>
