    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Mockflow</h1>
                <p class="text-gray-600 dark:text-gray-300"> MockFlow, your go-to wireframing tool for bringing your design ideas to life with ease. Designed with IT/CS students in mind, MockFlow offers a seamless experience for creating simple wireframes and prototypes.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/mockflow.png" alt="">
        ...
        <div class="tools-description-header">
            ...
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">User-Friendly Interface:  </span>  With MockFlow's intuitive drag-and-drop interface, designing wireframes has never been easier. Whether you're a beginner or an experienced designer, MockFlow's user-friendly tools make it simple to bring your ideas to fruition.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Pre-Designed Components:  </span>  Dive into your design projects quickly with MockFlow's extensive library of pre-designed components. From buttons and forms to navigation bars and icons, MockFlow provides everything you need to build professional-looking wireframes in no time.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Collaboration Made Simple:  </span> Collaborate with classmates and teammates effortlessly with MockFlow's built-in collaboration features. Share your wireframes, gather feedback in real-time, and work together to refine your designs for optimal results.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Efficient Prototyping: </span> Turn your wireframes into interactive prototypes with MockFlow's prototyping capabilities. Test out your designs, explore different user flows, and refine your ideas before moving on to the development stage.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Free to Use:  </span>  Best of all, MockFlow is completely free to use, making it accessible to students and professionals alike. Say goodbye to expensive software licenses and hello to a powerful wireframing tool that won't break the bank.</p>
            </div>
        </div>
    </section>
