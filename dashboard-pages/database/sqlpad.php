    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing SQL Pad</h1>
                <p class="text-gray-600 dark:text-gray-300"> Are you ready to excel in your next data interview and elevate your career to new heights? Introducing SQL Pad a comprehensive platform designed to help you master SQL, Python, and R, and become a sought-after data analytics and engineering expert.</p>
            </div>
            <div class="tools-image">
                <img src="../dash-images/sql-pad.png" alt="">
                <a href="https://sqlpad.io" target="_blank">
        ...
        <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> Whether you're a seasoned database administrator or a newcomer to database design, dbdiagram.io is the perfect tool for simplifying your database management process. </p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Tailored Courses </span>  Whether you're a beginner or an experienced professional, our courses cater to all skill levels and provide you with the knowledge and expertise you need to succeed in the world of data.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Interactive Coding Challenges:  </span> Put your skills to the test with our interactive coding challenges. From SQL queries to Python scripts and R code, our challenges provide hands-on experience and real-world scenarios to help you hone your coding skills and build confidence in your abilities.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Expert Insights:  </span>  Gain valuable insights and tips from industry experts in data engineering, data science, and AI. Our expert instructors share their knowledge and experience to help you navigate complex concepts and stay ahead of the curve in this rapidly evolving field.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Hands-on Exercises: </span> Dive into hands-on exercises and practical examples to reinforce your learning. Our interactive exercises allow you to apply what you've learned in real-world scenarios, giving you the practical experience you need to succeed in your career.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Career Growth: </span> Propel your professional growth and interview mastery with our comprehensive curriculum. Whether you're preparing for a job interview or looking to advance your career, our courses provide you with the skills and confidence you need to stand out in a competitive job market.</p>
            </div>
        </div>
    </section>
