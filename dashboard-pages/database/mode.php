    ...
    <section class="p-4 sm:ml-64">
        <div class="tools-header">
            <div class="tools-content">
                <h1 class="text-gray-900 dark:text-white"> Introducing Mode</h1>
        ...
        <div class="tools-description-content">
            ...
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Empowering Analysts: </span> Mode provides robust tools and functionalities that enable data analysts to delve deep into datasets, conduct complex analyses, and derive meaningful insights. With advanced querying capabilities and visualization options, analysts can unlock the full potential of their data.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Accessible Insights for End Users:  </span> Mode ensures that data is not just confined to the analyst's realm but is accessible and understandable for end-users as well. Through intuitive dashboards, interactive reports, and simplified data presentations, end-users can effortlessly access the information they need to drive informed decisions.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Comprehensive Platform: </span>  Serving as a full-stack, full-service platform, Mode covers every aspect of the data analysis process. From data preparation and exploration to analysis and visualization, Mode offers a seamless workflow that streamlines the entire data journey.</p>
            </div>
            <div class="tools-description-content">
                <p class="text-gray-600 dark:text-gray-300"> <span class="span-description">Inclusive Data Strategy: </span> By bridging the gap between analysts, end-users, and the broader team, Mode fosters a collaborative environment where everyone is involved in the data strategy. This inclusive approach ensures that insights are not siloed but are shared and utilized across the organization for maximum impact.</p>
            </div>
        </div>
    </section>
